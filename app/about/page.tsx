    ...
    return (
        <>
            ...
            <div className="flex justify-start ml-20 mt-24">
                ...
                <li>
                    Why my nickname is Serjei Mikailov?
                </li>
                <li>
                    My objectives?
                </li>
                ...
                <p className="mt-4 w-10/12">
                    Off course I'm human (i think...) My nickname is Serjei Mikailov inspired by a russian mobster, for no particular reason.
                     I'm very attracted to study Computer Enginnering, hardware and low level programming.
                    I'm a descentralized systems enjoyer and intending to live in USA or some european east country,
                    maybe Poland.
                     About hobbies i like to play competitive games as LOL, CSGO, and survival games as ARK and RUST, i also like philosophy and economy. Currently i'm studying Rust, C++
                    and a little bit about OpenGL.
